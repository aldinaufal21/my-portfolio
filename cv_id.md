# ALDY NAUFAL ALYYAFI
Lagoa, Jakarta Utara 14130 | +62895618959450 | aldinaufalalyyafi@gmail.com |
...
Saya adalah seorang Backend Developer yang berorientasi pada hasil dengan pengalaman solid dalam membangun aplikasi sisi server yang dapat diskalakan dan berkinerja tinggi menggunakan PHP dan Golang. Terampil dalam merancang dan mengoptimalkan basis data relasional (MySQL, PostgreSQL, Oracle) serta mengimplementasikan arsitektur layanan mikro yang efisien. Memiliki keahlian yang terbukti dalam memanfaatkan layanan cloud (AWS, GCP, Digital Ocean), mengelola pipeline CI/CD, sistem antrian pesan dan event streaming (RabbitMQ, Kafka), serta mengintegrasikan API pihak ketiga yang kompleks (Mailchimp, Airwallex, Firebase, Sendbird, layanan berbasis AI). Terbiasa bekerja dalam lingkungan kolaboratif dengan perencanaan pengembangan menggunakan metodologi Scrum (dibantu Jira, Confluence, dan Bitbucket), serta berkomitmen untuk memberikan kode yang bersih, mudah dikelola, dan skalabilitas sistem yang sejalan dengan tujuan bisnis.

---

## KEAHLIAN TEKNIS

* **Bahasa Pemrograman & Framework:** Golang, PHP, Laravel, Node.js, JavaScript, Vue.js, HTML, CSS, Bootstrap, SAP, WordPress.
* **Basis Data:** MySQL, Oracle, PostgreSQL, PL/SQL.
* **Cloud & Infrastruktur:** Amazon Web Services (AWS S3, SES, SNS), Digital Ocean, Docker, RabbitMQ, CI/CD, Kafka, Firebase, Google Cloud Platform.
* **Alat & Konsep:** Pengembangan REST API, Arsitektur Layanan Mikro (Microservices), Git, GitLab, Integrasi API Pihak Ketiga (mailchimp, sendbird, firebase, airwallex, matchmove, google calendar), Jira, Confluence, Bitbucket.
